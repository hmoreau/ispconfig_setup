...
sed -i 's/9000/9011/g' /opt/php-7.0.2/etc/php-fpm.d/www.conf
cat <<EOF >/etc/init.d/php-7.0.2-fpm 
#! /bin/sh
### BEGIN INIT INFO
...
insserv php-7.0.2-fpm

cat <<EOF >/lib/systemd/system/php-7.0.2-fpm.service 
[Unit]
